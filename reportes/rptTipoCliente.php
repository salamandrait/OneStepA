...
$pdf->fact_devP("Listado de Tipos de Clientes ","" );
...
while ($row = $rspta->fetch_assoc()) {
    ...
    $pdf->Cell(30,$colh, ''.utf8_decode($row['cod_tipocliente']),$yb,0,$yl,$fill);
    $pdf->Cell(135,$colh, ''.utf8_decode($row['desc_tipocliente']),$yb,0,$yl,$fill);
...
$pdf->AliasNbPages();
$pdf->Output('Listado de Tipos de Clientes','I');
?>