...
$pdf->fact_devP("Listado de Bancos ","" );
...
$pdf->Cell(105,$colh, 'Descripcion', 'LRB', 0,'C',$fill);
$pdf->Cell(30,$colh, 'Moneda','LRB', 0,'C',$fill);
...
while ($row = $rspta->fetch_assoc()) {
    ...
    $pdf->Cell(30,$colh, ' '.utf8_decode($row['cod_banco']),$yb,0,$yl,$fill);
    $pdf->Cell(105,$colh, ' '.utf8_decode($row['desc_banco']),$yb,0,$yl,$fill);
    $pdf->Cell(30,$colh, ' '.utf8_decode($row['desc_moneda']),$yb,0,$yl,$fill);
...
$pdf->AliasNbPages();
$pdf->Output('Listado de Bancos','I');
?>