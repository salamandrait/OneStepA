...
$pdf->fact_devP("Listado de Categorias ","" );
...
while ($row = $rspta->fetch_assoc()) {
    ...
    $pdf->Cell(30,$colh, ''.utf8_decode($row['cod_categoria']),$yb,0,$yl,$fill);
    $pdf->Cell(135,$colh, ''.utf8_decode($row['desc_categoria']),$yb,0,$yl,$fill);
...
$pdf->AliasNbPages();
$pdf->Output('Listado de Categorias','I');
?>
<?php
}
else
