...
$pdf->fact_devP("Listado de Unidades ","" );
...
while ($row = $rspta->fetch_assoc()) {
    ...
    $pdf->Cell(30,$colh, ''.utf8_decode($row['cod_unidad']),$yb,0,$yl,$fill);
    $pdf->Cell(135,$colh, ''.utf8_decode($row['desc_unidad']),$yb,0,$yl,$fill);
...
$pdf->AliasNbPages();
$pdf->Output('Listado de Unidades','I');
?>