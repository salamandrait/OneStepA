...
{
	$.post("../ajax/impuesto.php?op=mostrar",{idimpuesto : idimpuesto}, function(data)
	{
...
function desactivar(idimpuesto)
{
	bootbox.confirm({message:"¿Está Seguro de Desactivar el Registro?",
		...
		if(result)
        {
        	$.post("../ajax/impuesto.php?op=desactivar", {idimpuesto : idimpuesto}, function(e){
        		bootbox.alert(e);
				listar();
        	});	
        }
...
function activar(idimpuesto)
{
	bootbox.confirm({message:"¿Está Seguro de Activar el Registro?",buttons:{
		...
		if(result)
        {
        	$.post("../ajax/impuesto.php?op=activar", {idimpuesto : idimpuesto}, function(e){
        		bootbox.alert(e);
				listar();
        	});	
        }
...
function eliminar(idimpuesto)
{
	bootbox.confirm({message:"¿Está Seguro de Eliminar el Registro?",buttons:{
		...
		if(result)
        {
        	$.post("../ajax/impuesto.php?op=eliminar", {idimpuesto : idimpuesto}, function(e){
        		bootbox.alert(e);
	            listar();
        	});	
        }
