      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h1 class="box-title">Tipos de Clientes</h1>
            <button class="btn btn-success btn-sm" id="btnagregar" onclick="mostrarform(true)">
            <i class="fa fa-plus-circle"></i> Agregar</button>
            <a href="../reportes/rptTipoCliente.php" target="_blank">
        ...
        <div class="panel-body table-responsive" id="formularioregistros">
          <form name="formulario" id="formulario" method="POST">
            <div class="form-group col-lg-3 col-md-3 col-sm-8 col-xs-8">
              <label>Codigo:</label>
              <input hidden name="idtipocliente" id="idtipocliente">
              <input type="textc" class="form-control" name="cod_tipocliente" id="cod_tipocliente" maxlength="50" 
            ...
            <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
              ...
              <input text class="form-control" name="desc_tipocliente" id="desc_tipocliente" 
