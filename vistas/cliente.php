      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            ...
            <a href="../reportes/rptCliente.php" target="_blank">
        ...
        <div class="panel-body table-responsive" id="listadoregistros">
          <table id="tbllistado" class="table compact table-striped table-bordered table-condensed table-hover" style="width:100%">
            ...
            <th style="width:120px; text-align:center;" class="nd">Opciones</th>
              ...
              <th style="width:250px;">Tipo de Cliente</th>
        ...
        <div class="panel-body table-responsive" id="formularioregistros">
          <form name="formulario" id="formulario" method="POST">
            <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-8">
              ...
              <input type="textc" class="form-control" name="cod_cliente" id="cod_cliente" maxlength="50" 
              placeholder="Codigo" required rel="tooltip" data-original-title="Campo Obligatorio" required>
            </div>
            <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <label> Vendedor:</label>
            <select name="idvendedor" id="idvendedor" data-live-search="true" required class="selectpicker">
            </select>
            </div>
            <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
              <label>Tipo de Cliente:</label>
              <select name="idtipocliente" id="idtipocliente" class="form-control selectpicker" data-live-search="true" required>
              </select>
            </div>
            <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-8">
            ...
            <div class="form-group col-lg-9 col-md-9 col-sm-12 col-xs-12">
              ...
              <input text class="form-control" name="desc_cliente" id="desc_cliente" 
            ...
            <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-6">
              ...
              data-live-search="true" rel="tooltip" data-original-title="Campo Obligatorio" required>
            </select>
            </div> 
            <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-6">
              <label> Ciudad:</label>
            ...
            <div class="form-group col-lg-2 col-md-2 col-sm-4 col-xs-8">
              ...
              <div class="input-group">
                <span class="input-group-addon">
                  <label>Aplica:</label>
                  <input type="checkbox" name="aplicareten" id="aplicareten" class="validarchk">
                </span>
