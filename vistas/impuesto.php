        ...
        <div class="panel-body table-responsive" id="listadoregistros">
          <table id="tbllistado" class="table compact table-striped table-bordered table-condensed table-hover" style="width:100%">
            <thead class="bg-gray-active">
              ...
              <th style="width:100px; text-align:center;" class="nd">Tasa</th>
        ...
        <div class="panel-body table-responsive" id="formularioregistros">
          <form name="formulario" id="formulario" method="POST">
            <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-8">
              <label>Codigo:</label>
              <input hidden name="idimpuesto" id="idimpuesto">
              <input type="textc" class="form-control" name="cod_impuesto" id="cod_impuesto" maxlength="50" 
              placeholder="Codigo" required rel="tooltip" data-original-title="Campo Obligatorio" required>
            </div>
            <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-2">
            <label> Tasa:</label>
              <input text class="form-control" name="tasa" id="tasa" 
              placeholder="%" required style="text-align:right;">
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
            </div>
            <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
              <label> Descripción:</label>
              <input text class="form-control" name="desc_impuesto" id="desc_impuesto" 
