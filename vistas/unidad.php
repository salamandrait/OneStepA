        ...
        <div class="panel-body table-responsive" id="formularioregistros">
          <form name="formulario" id="formulario" method="POST">
            <div class="form-group col-lg-3 col-md-3 col-sm-8 col-xs-8">
              <label>Codigo:</label>
              <input hidden name="idunidad" id="idunidad">
              <input type="textc" class="form-control" name="cod_unidad" id="cod_unidad" maxlength="50" 
            ...
            <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
              ...
              <input text class="form-control" name="desc_unidad" id="desc_unidad" 
